...
wall23 = [650, 425, 25, 175]
wall24 = [700, 300, 25, 65]
wall25 = [200, 175, 75, 25]
...
def setup():
    global stage, player1, vel1, player1_speed, score1,\
           player2, vel2, player2_speed, score2, player3,\
           vel3, player3_speed, score3, coins, bad_coins,\
           win
    ...
    bad_coin5 = [400, 550, 25, 25]
    bad_coin6 = [70, 100, 25, 25]
    bad_coin7 = [150, 250, 25, 25]
    bad_coin8 = [300, 300, 25, 25]
    bad_coin9 = [700, 500, 25, 25]
    bad_coin10 = [500, 480, 25, 25]
    bad_coin11 = [300, 400, 25, 25]
    bad_coin12 = [200, 400, 25, 25]

    bad_coins = [bad_coin1, bad_coin2, bad_coin3, bad_coin4, bad_coin5,\
                 bad_coin6, bad_coin7, bad_coin8, bad_coin9, bad_coin10,\
                 bad_coin11, bad_coin12]
...
while not done:
    ...
    if stage == PLAYING:
        ...
        player3_up = pressed[pygame.K_i]
        player3_down = pressed[pygame.K_k]
        player3_left = pressed[pygame.K_j]
        player3_right = pressed[pygame.K_l]
    ...
    if stage == PLAYING:
        ...
        for w in walls:
            if intersects.rect_rect(player1, w):        
                ...
                if vel2[0] > 0:
                    ...
                    player2[0] = w[0] + w[2]
            elif intersects.rect_rect(player3, w):        
                if vel3[0] > 0:
        ...
        for c in coins:
            if intersects.rect_rect(player1, c):
                ...
                hit_list2.append(c)
            elif intersects.rect_rect(player3, c):
                hit_list3.append(c)
        ...
        for b in bad_coins:
            if intersects.rect_rect(player1, b):
                ...
                hit_list5.append(b)
            elif intersects.rect_rect(player3, b):
                hit_list6.append(b)
        ...
        hit_list4 = [b for b in bad_coins if intersects.rect_rect(player1, b)]
        hit_list5 = [b for b in bad_coins if intersects.rect_rect(player2, b)]
        hit_list6 = [b for b in bad_coins if intersects.rect_rect(player3, b)]
    ...
    pygame.draw.rect(screen, ORANGE, player3)
    ...
    if stage == START:
        ...
        text1 = MY_FONT.render("Welcome to the Beautiful Maze Game", True, INDIGO)
        text2 = MY_FONT.render("(Press SPACE to play)", True, INDIGO)
        screen.blit(text1, [100, 400])
        screen.blit(text2, [225, 500])
    ...
    font = pygame.font.Font(None, 30)
    score_text = font.render("Player 3 Score: " + str(score3), 1, ORANGE)
    screen.blit(score_text, [600, 575])
    ...
    if win:
        if score1 > score2 and score1 > score3:
            ...
            font = pygame.font.Font(None, 50)
            score_text = font.render("Player 3 Wins!!!", 1, BRIGHT_BLUE)
            screen.blit(score_text, [275, 50])
        elif score1 == score2 and score1 > score3:
            font = pygame.font.Font(None, 50)
            score_text = font.render("Draw For P1 and P2!", 1, BRIGHT_BLUE)
            screen.blit(score_text, [300, 50])
        elif score1 == score3 and score1 > score2:
            font = pygame.font.Font(None, 50)
            score_text = font.render("Draw For P1 and P3!", 1, BRIGHT_BLUE)
            screen.blit(score_text, [300, 50])
        elif score2 == score3 and score2 > score1:
            font = pygame.font.Font(None, 50)
            score_text = font.render("Draw For P2 and P3!", 1, BRIGHT_BLUE)
            screen.blit(score_text, [300, 50])
        elif score1 == score2 and score1 == score3:
            font = pygame.font.Font(None, 50)
            score_text = font.render("Draw For All", 1, BRIGHT_BLUE)
